...
async function main() {
	...
	console.log('Seeded QuyDinhKyTucXa');
	...
	// 3. Ensure an Employee exists (Sale & QuanLy)
	...
	console.log('Seeded HoSoDatCoc with ID:', hoSoDatCoc.hoSoDatCocId);
}
